...
export default function Documentation() {
  return (
    <DocLayout
      ...
      description="Guide to get started with Varyans Modern & Multipurpose Bootstrap 5 Template.">
      {/* ========== section 1 ========== */}
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <p>
              This guide will help you get started with Varyans. All the information regarding file structure, build
        ...
        <div className="card">
          <div className="card-body">
            <ul className="list-unstyled mb-0">
              ...
              <li>
                <code className="folder bg-pale-primary">src</code> All template source files like Pages / Components /
                SCSS / Data / Icon / Hooks that are exist inside this folder.
                <ul>
                  <li>
                    <code className="folder bg-pale-primary">app</code> All pages exist inside this folder.{" "}
                    <strong>Use this folder</strong> if you want to create new page or edit any page.
                  </li>

                  <li>
                    <code className="folder bg-pale-primary">src/assets</code> Contains main SCSS & Fonts
                  </li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <code className="folder bg-pale-primary">src/components/reusable</code> Contains all reusable
        ...
        <div className="card">
          <div className="card-body">
            <ol className="mb-0">
              ...
              <li>
                Unzip the template package and in the root project folder <code className="folder">Varyans</code>, go to
