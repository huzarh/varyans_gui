...
export default function Fonts() {
  ...
  return (
    <DocLayout
      ...
      description="Use one of the existing font options or a custom font of your choice to change the overall font in Varyans.">
      {/* ========== section 1 ========== */}
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            ...
            {/* <p className="mb-0">
              Manrope is the default font in Varyans. If you wish to use one of the other available font options, add
