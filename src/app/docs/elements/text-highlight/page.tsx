    ...
    <DocLayout
        ...
        <div className="card">
          <div className="card-body">
            <p className="lead mb-0">
              Build and manage an <span className="underline">impressive</span> website with Varyans in no time.
            </p>
          </div>
        ...
        <div className="card">
          <div className="card-body">
            <h2 className="display-3 lh-xs mb-4">
              Build and manage an <span className="underline-2 yellow">impressive</span> website with Varyans in no
              time.
            </h2>
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <h2 className="display-3 lh-xs mb-4">
              Build and manage an <span className="underline-3 style-1 red">impressive</span> website with Varyans in no
              time.
            </h2>
            <h2 className="display-3 lh-xs mb-4">
              Build and manage an <span className="underline-3 style-2 yellow">impressive</span> website with Varyans in
              no time.
            </h2>
            <h2 className="display-3 lh-xs mb-4">
              Build and manage an <span className="underline-3 style-3 green">impressive</span> website with Varyans in
              no time.
            </h2>
          </div>
