...
export default function Credits() {
  return (
    <DocLayout
      ...
      description="List of source links of JS, images, icons and illustrations used in Varyans.">
      {/* ========== section 1 ========== */}
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <h3>Pexels</h3>
            <p className="mb-5">
              To reach the collection of all images/videos from Pexels used in Varyans, click{" "}
              <a
                href="https://www.pexels.com/collections/Varyans-gbw1t9c/"
                className="external"
                target="_blank"
                rel="noreferrer">
                here
            ...
            <h3>Rawpixel</h3>
            <p className="mb-5">
              To reach the collection of all images from Rawpixel used in Varyans, click{" "}
              <a
                href="https://www.rawpixel.com/community-board/1391692/Varyans?sort=last_added&mode=shop&page=1"
                className="external"
                target="_blank"
                rel="noreferrer">
                here
            ...
            <h3>Unsplash</h3>
            <p className="mb-5">
              To reach the collection of all images from Unsplash used in Varyans, click{" "}
              <a
                href="https://unsplash.com/collections/vn4OtMorwCA/Varyans"
                className="external"
                target="_blank"
                rel="noreferrer">
                here
            ...
            <p className="mb-5">
              ...
              <a
                href="https://www.freepik.com/user/collections/Varyans/2260699"
                className="external"
                target="_blank"
                rel="noreferrer">
                here
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          To reach the collections of icons used in Varyans, go to pages{" "}
      ...
      <section id="snippet-4" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          To reach the collections of illustrations used in Varyans, click{" "}
