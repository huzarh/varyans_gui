...
export default function Info({
  address,
  title = "Varyans",
  phone = "+90 534 718 94 25",
  description = `______ _______ _____   _____ _______ ______ _____ ___ ____.`
}: InfoProps) {
  const otherPages = [
    { title: "Our Story", url: "#" },
  ...
  return (
    <div className="offcanvas offcanvas-end text-inverse" id="offcanvas-info" data-bs-scroll="true">
      ...
      <div className="offcanvas-body pb-6">
        ...
        <div className="widget mb-8">
          <h4 className="widget-title text-white mb-3">İletşim</h4>
          {address ? (
            <address>{address}</address>
          ) : (
            <address>
              Sakarya Serdivan <br /> Kampüs TYK
            </address>
          )}
        ...
        <div className="widget">
          <h4 className="widget-title text-white mb-3">Takip et</h4>
