...
export const processList1 = [
  {
    ...
    subtitle: "_____ __________ __________ ______ "
  },
  {
    no: "2",
    title: "Görevin uyugun dağılması",
    className: "ms-lg-13 mt-6",
    subtitle: "_____ ________ ________ _______"
  },
  {
    no: "3",
    title: "Sonuç değirlendirme",
    className: "mx-lg-6 mt-6",
    subtitle: "______ ______ _______ _____"
  }
];
